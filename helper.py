...
def most_successful(df, sport):
    ...
    merged_x = x.merge(df, on='Name', how='left')[['Name', 'Medal Count', 'Sport', 'region']].drop_duplicates('Name')
...
def most_successful_countrywise(df, country):
    ...
    merged_x = x.merge(df, on='Name', how='left')[['Name', 'Medal Count', 'Sport']].drop_duplicates('Name')
